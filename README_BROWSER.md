...
2. You need to install `reflect-metadata` shim:
    ...
    * `<script src="./node_modules/reflect-metadata/Reflect.js"></script>` in your app's entry point (for example `index.html`)

#### How to setup system.js
...
We are using websql in this example, its the only driver supported in the browser.
...
Take a look on example how to use typeorm in browser [here](https://github.com/typeorm/browser-example).
