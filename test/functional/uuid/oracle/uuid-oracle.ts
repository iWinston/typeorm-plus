...
describe.only("uuid-oracle", () => {
    ...
    it("should persist uuid correctly when it is generated non primary column", () => Promise.all(connections.map(async connection => {
        ...
        postTable!.findColumnByName("uuid")!.type.should.be.equal("varchar2");
        ...
        questionTable!.findColumnByName("id")!.type.should.be.equal("varchar2");
        questionTable!.findColumnByName("uuid")!.type.should.be.equal("varchar2");
        questionTable!.findColumnByName("uuid2")!.type.should.be.equal("varchar2");
        questionTable!.findColumnByName("uuid3")!.type.should.be.equal("varchar2");
