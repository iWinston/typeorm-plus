...
```json
{
    ...
    "database": "test",
    "entities": ["entity/*.js"],
    "migrationTable": "custom_migration_table",
...
* `"migrationTable": "migrations"` - Specify this option only if you need migration table name to be different from `"migrations"`.
