...
export class PostgresQueryRunner extends BaseQueryRunner implements QueryRunner {
    ...
    async insert(tableName: string, keyValues: ObjectLiteral): Promise<InsertResult> {
        ...
        const sql = columns.length > 0
            ? `INSERT INTO ${this.escapeTableName(tableName)}(${columns}) VALUES (${values}) ${generatedColumnSql}`
            : `INSERT INTO ${this.escapeTableName(tableName)} DEFAULT VALUES ${generatedColumnSql}`;
