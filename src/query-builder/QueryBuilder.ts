...
export class QueryBuilder<Entity> {
        ...
        try {
            ...
            if (this.expressionMap.skip || this.expressionMap.take) {
                ...
                if (rawResults.length > 0) {
                    ...
                    const clonnedQb = this.clone({queryRunner: this.queryRunner});
     ...
     */
    clone(options?: { queryRunner?: QueryRunner }): QueryBuilder<Entity> {
        const qb = this.connection.createQueryBuilder(options ? options.queryRunner : undefined);
