...
export class ReturningResultsLoader {
    ...
    async load(valueSets: ObjectLiteral[], raw: ObjectLiteral|ObjectLiteral[]): Promise<[ObjectLiteral[], ObjectLiteral[]]> {
        ...
        await Promise.all(valueSets.map(async (valueSet, valueSetIndex) => {
            ...
            const result = raw instanceof Array ? raw[valueSetIndex] : raw;
